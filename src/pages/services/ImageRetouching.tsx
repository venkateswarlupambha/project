...
import { Sparkles, CheckCircle, Star, Eye, Heart, Brush } from "lucide-react";
      ...
      <div className="pt-16 sm:pt-20 lg:pt-24">
        <section className="py-12 px-4">
          <div className="container mx-auto">
            <ServiceBreadcrumb serviceName="Image Retouching" />
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Professional retouching for flawless, natural-looking results
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        ...
                        "Light enhancement and balance",
                        "Detail refinement and sharpening",
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <Card className="bg-slate-800/50 border-slate-700 text-center">
                    <CardHeader>
                      ...
                      <CardTitle className="text-white">Skin Smoothing</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-300">Flawless complexion</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-slate-800/50 border-slate-700 text-center">
                    ...
                    <CardContent>
                      <p className="text-gray-300">Perfect illumination</p>
                    </CardContent>
                  </Card>

                  <Card className="bg-slate-800/50 border-slate-700 text-center">
                    <CardHeader>
                      <Brush className="w-8 h-8 text-green-400 mx-auto mb-2" />
                      <CardTitle className="text-white">Detail Refinement</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-300">Enhanced clarity</p>
                    </CardContent>
                  </Card>
                </div>
              </div>
              ...
              <div>
                <Card className="bg-slate-800/50 border-slate-700 sticky top-8">
                  ...
                  <CardContent>
                    <ContactForm prefilledService="Image Retouching (Skin, Light, Details)" />
                  </CardContent>
                </Card>
              </div>
            </div>
