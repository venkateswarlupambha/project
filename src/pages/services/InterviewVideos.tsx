...
import { User, CheckCircle, Star, FileText, Mic, Video } from "lucide-react";
      ...
      <div className="pt-16 sm:pt-20 lg:pt-24">
        <section className="py-12 px-4">
          <div className="container mx-auto">
            <ServiceBreadcrumb serviceName="Self-Introduction & Interview Videos" />
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Professional interview and introduction video creation for career advancement
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <Card className="bg-slate-800/50 border-slate-700 text-center">
                    <CardHeader>
                      ...
                      <CardTitle className="text-white">Script Support</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-300">Professional guidance</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-slate-800/50 border-slate-700 text-center">
                    <CardHeader>
                      ...
                      <CardTitle className="text-white">Professional Look</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-300">Corporate standard</p>
                    </CardContent>
                  </Card>
                </div>
              </div>
                ...
                <Card className="bg-slate-800/50 border-slate-700 sticky top-8">
                  <CardHeader>
                    ...
                    <CardDescription className="text-gray-300">
                      Interview video creation
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ContactForm prefilledService="Self-Introduction & Interview Videos" />
                  </CardContent>
                </Card>
              </div>
            </div>
