...
import { FileImage, CheckCircle, Star, Printer, Monitor, Target } from "lucide-react";
      ...
      <div className="pt-16 sm:pt-20 lg:pt-24">
        <section className="py-12 px-4">
          <div className="container mx-auto">
            <ServiceBreadcrumb serviceName="Flyer Design" />
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Professional flyers for digital and print marketing campaigns
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <Card className="bg-slate-800/50 border-slate-700 text-center">
                    <CardHeader>
                      <Printer className="w-8 h-8 text-red-400 mx-auto mb-2" />
                      <CardTitle className="text-white">Print Ready</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-300">High quality prints</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-slate-800/50 border-slate-700 text-center">
                    <CardHeader>
                      ...
                      <CardTitle className="text-white">Digital Optimized</CardTitle>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card className="bg-slate-800/50 border-slate-700 text-center">
                    <CardHeader>
                      ...
                      <CardTitle className="text-white">Marketing Focused</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-300">Results driven</p>
                    </CardContent>
                  </Card>
                </div>
              </div>
              ...
              <div>
                <Card className="bg-slate-800/50 border-slate-700 sticky top-8">
                  ...
                  <CardContent>
                    <ContactForm prefilledService="Flyer Design" />
                  </CardContent>
                </Card>
              </div>
            </div>
